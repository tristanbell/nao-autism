...
static const char qt_meta_stringdata_FileMenu[] = {
    ...
    "saveAsTriggered()\0onSuccessfulOpen(std::string)\0"
    "reason\0onUnsuccessfulOpen(std::string)\0"
    "onSuccessfulSave(std::string)\0"
    "onUnsuccessfulSave(std::string)\0"
};
...
void FileMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->onSuccessfulOpen((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        case 7: _t->onUnsuccessfulOpen((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        case 8: _t->onSuccessfulSave((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        case 9: _t->onUnsuccessfulSave((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
